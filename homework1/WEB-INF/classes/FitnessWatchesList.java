...
public class FitnessWatchesList extends HttpServlet {
	...
	/* FitnessWatch Page Displays all the Fitnesswatches and their Information in Game Speed */
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
		   if(CategoryName.equals("Fitbit"))
		   {
		   ...
		   else if(CategoryName.equals("Polar"))
		    {
			for(Map.Entry<String,FitnessWatch> entry : allfitnesswatches.entrySet())
				{
				 if(entry.getValue().getRetailer().equals("Polar"))
				 {
					 hm.put(entry.getValue().getId(),entry.getValue());
				 }
				}
			...
			else if(CategoryName.equals("Moko"))
			{
				for(Map.Entry<String,FitnessWatch> entry : allfitnesswatches.entrySet())
				{
				 if(entry.getValue().getRetailer().equals("Moko"))
				 {
					 hm.put(entry.getValue().getId(),entry.getValue());
				 }
				}
