...
public class Payment extends HttpServlet {
		...
		if(!userAddress.isEmpty() && !creditCardNo.isEmpty() && !orderdate.isEmpty() )
		{
			...
			pw.print("</br><br><br><br><br><br><br><br> <h4><b>Thank you for shopping with us...");
			pw.print("<br> <h4> <b>The estimated delivery date is 10/07/2019 </br>");
			pw.print("<br><b> If you wish to cancel the order, it can be canceled 5 business days before the delivery orderdate.</br>");
