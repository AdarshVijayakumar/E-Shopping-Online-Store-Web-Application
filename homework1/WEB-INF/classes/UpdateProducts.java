...
public class UpdateProducts extends HttpServlet {
	...
	protected void displayLogin(HttpServletRequest request,
		...
		pw.print("<h2 class='title meta' style='text-align:center; padding-top:20px;'><a style='font-size:32px; color:#ffffff; text-align:center;'>Update Product</a></h2>"
				+ "<div class='entry'>"
				+ "<div style='width:400px; margin:25px; margin-left: auto;margin-right: auto;'>");

		pw.print("<form name ='UpdateProduct' method='post'>");

		pw.print("<p style='font-size:16px; font-weight:bold; color:#ffffff; text-align:center; padding-top:50px;'>Enter the product details that are to be updated</p>");
		pw.print("<table>");	
		...
		pw.print("<input type='submit' name='Update Product' class='btnbuy'>");
