...
public class ManageProducts extends HttpServlet {
	...
	protected void displayLogin(HttpServletRequest request,
		...
		pw.print("<p style='font-size:20px; color:#333333; text-align:center;'><a href='ProductModify?button=Addproduct'>Add Product</a></p>");
		pw.print("<p style='font-size:20px; color:#333333; text-align:center;'><a href='ProductModify?button=Updateproduct'>Update Product</a></p>");
		pw.print("<p style='font-size:20px; color:#333333; text-align:center;'><a href='ProductModify?button=Deleteproduct'>Delete Product</a></p>");		
