...
public class SoundSystemsList extends HttpServlet {
	...
	/* SoundSystems Page Displays all the soundsystems and their Information in Game Speed */
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{
			SoundSystem SoundSystems = entry.getValue();
			if(i%3==1) pw.print("<tr>");
			pw.print("<td><div id='shop_item'>");
			pw.print("<h3>"+SoundSystems.getName()+"</h3>");
			pw.print("<strong>$"+SoundSystems.getPrice()+"</strong><ul>");
			pw.print("<li id='item'><img src='images/soundsystem/"+SoundSystems.getImage()+"' alt='' /></li>");
			...
			pw.print("<li><form method='post' action='WriteReview'>"+"<input type='hidden' name='name' value='"+entry.getKey()+"'>"+
					...
					"<input type='hidden' name='maker' value='"+CategoryName+"'>"+
					"<input type='hidden' name='price' value='"+SoundSystems.getPrice()+"'>"+
					"<input type='hidden' name='access' value=''>"+
