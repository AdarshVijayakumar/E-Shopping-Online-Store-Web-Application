...
////////////////////////////////////////////////////////////
    ...
    public void endElement(String str1, String str2, String element) throws SAXException {
        ...
        if (element.equalsIgnoreCase("discount")) {
			//productDiscount = elementValueRead;
            if(currentElement.equals("tv")){
            ...
            //MySqlDataStoreUtilities.Insertproducts(producttype,productId,productName,productPrice,productImage,productManufacturer,productCondition,productDiscount,prod);
...
//call the constructor to parse the xml and get product details
 public static void addHashmap() {
		...
		new SaxParserDataStore(TOMCAT_HOME+"\\webapps\\homework1\\ProductCatalog.xml");
    } 
