...
public class Inventory extends HttpServlet {
	...
	protected void displayLogin(HttpServletRequest request,
		...
		pw.print("<table style=\"font-size:14px; width:100%;color:#333334\">");
					pw.print("<tr>");
					
					pw.print("<h1 style=\"color: #777;border-bottom: 2px solid #777;\">Product Inventory Details</h1>");
					pw.print("</td>");
					...
					pw.print("<br/>");
					pw.print("<div >");
					pw.print("<table style=\"font-size:12px; width:80%;color:orange\">");					
					pw.print("<tr>");
					pw.print("<th align=\"center\" width=\"75%\">");
					pw.print("<span style=\"font-size:24px;font-weight: bold\">Product</span>");
					pw.print("</th>");
					pw.print("<th align=\"center\" width=\"35%\">");
					pw.print("<span style=\"font-size:24px;font-weight: bold\">Price</span>");
					pw.print("</th>");
					pw.print("<th align=\"center\" width=\"30%\">");
					pw.print("<span style=\"font-size:24px;font-weight: bold\">Item Count</span>");
					pw.print("</th>");
					pw.print("</tr>");
					pw.print("</table>");
					...
					if(pMap != null){
						if(pMap.isEmpty()){
							...
							for (HashMap.Entry<String,Product> entry : pMap.entrySet()) {
								...
								pw.print("<table style=\"font-size:10px; width:80%;color:white\">");			    
								pw.print("<tr>");
								pw.print("<td  width=\"70%\">");
								...
								pw.print("</td>");
								pw.print("<td align=\"center\" width=\"15%\">");	
								pw.print("<span style=\"font-size:20px\">"+product.getProdcount()+"</span>");						
								pw.print("</td>");								
								pw.print("</tr>");               
								pw.print("</table>");
							}
