...
public class DealMatchesUtilities extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.print("<h2>Tweets from the twitter</h2>");
		pw.print("<br> <br>");
		pw.print("<br> <br>");
			...
			BufferedReader reader = new BufferedReader(new FileReader (new File(TOMCAT_HOME+"\\webapps\\homework1\\DealMatches.txt")));
		...
		//System.out.println("................................");
		//System.out.println(entry.getValue().getImageUrl());
		pw.print("<li id='item'><img src='images/"+entry.getValue().getType()+"/"+entry.getValue().getImageUrl()+"' alt='' />");
		pw.print("</li><li>");
