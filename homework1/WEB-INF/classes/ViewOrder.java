...
protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("Order")!=null && request.getParameter("Order").equals("ViewOrder"))
		{
			...
			{	
				...
				{	
					...
					pw.print("<tr><td></td>");
					pw.print("<td><b>OrderId</td>");
					pw.print("<td><b>User Name</td>");
					pw.print("<td><b>product Ordered</td>");
					pw.print("<td><b>productPrice:</td>");
					pw.print("<td><b>Delivery Status</td></tr>");
					for (OrderPayment oi : orderPayments.get(orderId)) 
					{
						pw.print("<tr>");			
						pw.print("<td><input type='radio' name='orderName' value='"+oi.getOrderName()+"'></td>");			
						pw.print("<td>"+oi.getOrderId()+".</td><td>"+oi.getUserName()+"</td><td>"+oi.getOrderName()+"</td><td>Price: "+oi.getOrderPrice()+"</td><td>Pending</td>");
		...
		if(request.getParameter("Order")!=null && request.getParameter("Order").equals("CancelOrder"))
		{
			if(request.getParameter("orderName") != null)
			{
				...
				for (OrderPayment oi : orderPayments.get(orderId)) 
					{
						//String usertype = oi.getUserType();
