	...
	protected void doGet(HttpServletRequest request,
		...
		if(action.equals("Addproduct"))
		{
			...
			pw.print("<form method='get' action='ProductCrud'>"
					...
					+ "<h3>Product Type</h3></td><td><select name='producttype' class='input'><option value='TV' selected>TV</option><option value='soundsystem'>soundsystem</option><option value='phone'>phone</option><option value='laptop'>laptop</option><option value='voiceassistant'>voiceassistant</option><option value='fitnesswatch'>fitnesswatch</option><option value='smartwatches'>smart watch</option><option value='headphone'>headphone</option><option value='wirelessplan'>wirelessplan</option></select>"
					+ "</td></tr><tr><td>"
		...
		}else if (action.equals("Updateproduct"))
		{
			...
			pw.print("<form method='get' action='ProductCrud'>"
					+ "<table id='bestseller'><tr><td>"
					+ "<h3>Product Type</h3></td><td><select name='producttype' class='input'><option value='TV' selected>TV</option><option value='soundsystem'>soundsystem</option><option value='phone'>phone</option><option value='laptop'>laptop</option><option value='voiceassistant'>voiceassistant</option><option value='fitnesswatch'>fitnesswatch</option><option value='smartwatch'>smartwatch</option><option value='headphone'>headphone</option><option value='wirelessplan'>wirelessplan</option></select>"
					+ "</td></tr><tr><td>"
					+ "<h3>Product Id</h3></td><td><input type='text' name='productId' value='' class='input' required></input>"
					+ "</td></tr><tr><td>"
					+ "<h3>Product Name</h3></td><td><input type='text' name='productName' value='' class='input' required></input>"
