...
public class CheckOut extends HttpServlet {
	...
	protected void storeOrders(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.print("<p style='font-size:15px;color:#333333;padding-top:20px;font-weight:bold'>Customer Name: "+userName +"</p>");
		pw.print("<table  class='gridtable'><tr><td style='font-weight:bold'>Product Name</td>");
		pw.print("<td style='font-weight:bold'>Price</td><td></tr>");
		...
		for (OrderItem oi : utility.getCustomerOrders()) 
		{
			...
			if(oi.getName()!= "Warranty"){
				pw.print("<td style='font-size:14px; text-align:center;'><a href='Warranty'>Buy Warranty </a></td>");
			}
			pw.print("<input type='hidden' name='orderPrice' value='"+oi.getPrice()+"'>");
			pw.print("<input type='hidden' name='orderName' value='"+oi.getName()+"'>");
			pw.print("</td><td></td></tr>");
		...
		pw.print("</td><td></td></tr></table><table><tr></tr><tr></tr>");	
		pw.print("<tr><td><b>");
        ...
        pw.print("<tr>");
		pw.print("<td><b> orderdate: </td>");
		pw.print("<td> <input type='date' name='orderdate'> </td>");
        pw.print("</tr>");
