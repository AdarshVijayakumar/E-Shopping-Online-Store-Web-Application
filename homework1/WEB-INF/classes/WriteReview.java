		...
		pw.print("<input type='hidden' name='productmaker' value='"+productmaker+"'>");
                pw.print("</td></tr><table>");
  				...
  				pw.print("<table><tr></tr><tr></tr><tr><td><b> Review Rating: </td>");
			        ...
			        pw.print("</tr>");
					pw.print("<tr>");
					pw.print("<td><b> Retailer Zip Code: </td>");
